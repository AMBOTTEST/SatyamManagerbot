...
buttons = [
    [
        InlineKeyboardButton(
            text="➕ ᴀᴅᴅ ᴍᴇ ʏᴏᴜʀ ɢʀᴏᴜᴘ", url=f"t.me/{BOT_USERNAME}?startgroup=true"
        )
    ],
    [
    ...
    if update.effective_chat.type == "private":
        if len(args) >= 1:
            ...
            update.effective_message.reply_sticker(
                "CAACAgUAAxkBAAEDGhVlDcmb3RBPyndV8tGTCkiChTSXGwAChgUAAtS8mVdCimiphN1GGjAE"
            )
...
def donate(update: Update, context: CallbackContext):
    ...
    if chat.type == "private":
        ...
        if OWNER_ID != 6204761408 and DONATION_LINK:
            update.effective_message.reply_text(
...
━━━━━━━━━━━━━
⍟ **ᴍʏ ᴏᴡɴᴇʀ :** [ꜱᴀᴛʏᴀᴍ](https://t.me/{OWNER_USERNAME})
